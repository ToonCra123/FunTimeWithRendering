...
Icosphere::Icosphere(Shaders *mProgram, const glm::vec3 &color) {
...
void Icosphere::render(glm::mat4 &projection, glm::mat4 &view, glm::vec3 &camPos, float &timeval, Light &light) {
